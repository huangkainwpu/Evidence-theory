...
简介
----------
* 对于一个特定的问题，其的解存在多个可能性。但是现在我们缺失了一些至关重要的信息，因此我们很难得到这个问题的精确解。证据理论即引入不确定性，将信任度分配到这些解构成的集合中去。其与Bayesian最大的不同即是Bayesian考虑的是单元素集合，而D-S理论还考虑多元素集合，复杂度更高同时结果更加精确可靠。
